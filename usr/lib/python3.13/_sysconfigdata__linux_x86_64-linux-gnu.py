...
build_time_vars = {
    ...
    'CONFIG_ARGS': "'--host=x86_64-pc-linux-gnu' '--build=x86_64-pc-linux-gnu' '--target=x86_64-pc-linux-gnu' '--prefix=/usr' '--enable-ipv6' '--enable-loadable-sqlite-extensions' '--enable-optimizations' '--enable-shared' '--with-lto' '--with-computed-gotos' '--with-dbmliborder=gdbm:ndbm' '--with-system-expat' '--with-system-libmpdec' '--without-ensurepip' '--with-builtin-hashlib-hashes=blake2' '--with-wheel-pkg-dir=/usr/share/python-wheels' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=x86_64-pc-linux-gnu' 'target_alias=x86_64-pc-linux-gnu'",
    'CONFINCLUDEDIR': '/usr/include',
    'CONFINCLUDEPY': '/usr/include/python3.13',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/home/build/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/home/build/lcov-report',
    ...
    'JIT_DEPS': '\\',
    'LDCXXSHARED': 'x86_64-pc-linux-gnu-c++ -shared',
    'LDFLAGS': '',
    ...
    'LIBEXPAT_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -fno-semantic-interposition -flto -fuse-linker-plugin -ffat-lto-objects -flto-partition=none -g -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-use -fprofile-correction -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -fPIC',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    ...
    'LIBMPDEC_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -fno-semantic-interposition -flto -fuse-linker-plugin -ffat-lto-objects -flto-partition=none -g -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-use -fprofile-correction -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -fPIC',
    'LIBMPDEC_HEADERS': '\\',
    'LIBMPDEC_OBJS': '\\',
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    ...
    'MODULE__CTYPES_LDFLAGS': '-L/usr/lib/../lib64 -lffi -ldl',
    ...
    'RESSRCDIR': '',
    'RETSIGTYPE': 'void',
    'RUNSHARED': 'LD_LIBRARY_PATH=/home/build',
    'SCRIPTDIR': '/usr/lib',
    'SCRIPT_IDLE': 'build/scripts-3.13/idle3.13',
    'SCRIPT_PYDOC': 'build/scripts-3.13/pydoc3.13',
    'SETPGRP_HAVE_ARG': 0,
    'SHAREDMODS': 'Modules/array.cpython-313-x86_64-linux-gnu.so Modules/_asyncio.cpython-313-x86_64-linux-gnu.so Modules/_bisect.cpython-313-x86_64-linux-gnu.so Modules/_contextvars.cpython-313-x86_64-linux-gnu.so Modules/_csv.cpython-313-x86_64-linux-gnu.so Modules/_heapq.cpython-313-x86_64-linux-gnu.so Modules/_json.cpython-313-x86_64-linux-gnu.so Modules/_lsprof.cpython-313-x86_64-linux-gnu.so Modules/_opcode.cpython-313-x86_64-linux-gnu.so Modules/_pickle.cpython-313-x86_64-linux-gnu.so Modules/_queue.cpython-313-x86_64-linux-gnu.so Modules/_random.cpython-313-x86_64-linux-gnu.so Modules/_struct.cpython-313-x86_64-linux-gnu.so Modules/_interpreters.cpython-313-x86_64-linux-gnu.so Modules/_interpchannels.cpython-313-x86_64-linux-gnu.so Modules/_interpqueues.cpython-313-x86_64-linux-gnu.so Modules/_zoneinfo.cpython-313-x86_64-linux-gnu.so Modules/math.cpython-313-x86_64-linux-gnu.so Modules/cmath.cpython-313-x86_64-linux-gnu.so Modules/_statistics.cpython-313-x86_64-linux-gnu.so Modules/_datetime.cpython-313-x86_64-linux-gnu.so Modules/_decimal.cpython-313-x86_64-linux-gnu.so Modules/binascii.cpython-313-x86_64-linux-gnu.so Modules/_bz2.cpython-313-x86_64-linux-gnu.so Modules/_lzma.cpython-313-x86_64-linux-gnu.so Modules/zlib.cpython-313-x86_64-linux-gnu.so Modules/_gdbm.cpython-313-x86_64-linux-gnu.so Modules/readline.cpython-313-x86_64-linux-gnu.so Modules/_blake2.cpython-313-x86_64-linux-gnu.so Modules/pyexpat.cpython-313-x86_64-linux-gnu.so Modules/_elementtree.cpython-313-x86_64-linux-gnu.so Modules/_codecs_cn.cpython-313-x86_64-linux-gnu.so Modules/_codecs_hk.cpython-313-x86_64-linux-gnu.so Modules/_codecs_iso2022.cpython-313-x86_64-linux-gnu.so Modules/_codecs_jp.cpython-313-x86_64-linux-gnu.so Modules/_codecs_kr.cpython-313-x86_64-linux-gnu.so Modules/_codecs_tw.cpython-313-x86_64-linux-gnu.so Modules/_multibytecodec.cpython-313-x86_64-linux-gnu.so Modules/unicodedata.cpython-313-x86_64-linux-gnu.so Modules/fcntl.cpython-313-x86_64-linux-gnu.so Modules/grp.cpython-313-x86_64-linux-gnu.so Modules/mmap.cpython-313-x86_64-linux-gnu.so Modules/_posixsubprocess.cpython-313-x86_64-linux-gnu.so Modules/resource.cpython-313-x86_64-linux-gnu.so Modules/select.cpython-313-x86_64-linux-gnu.so Modules/_socket.cpython-313-x86_64-linux-gnu.so Modules/syslog.cpython-313-x86_64-linux-gnu.so Modules/termios.cpython-313-x86_64-linux-gnu.so Modules/_posixshmem.cpython-313-x86_64-linux-gnu.so Modules/_multiprocessing.cpython-313-x86_64-linux-gnu.so Modules/_ctypes.cpython-313-x86_64-linux-gnu.so Modules/_curses.cpython-313-x86_64-linux-gnu.so Modules/_curses_panel.cpython-313-x86_64-linux-gnu.so Modules/_sqlite3.cpython-313-x86_64-linux-gnu.so Modules/_ssl.cpython-313-x86_64-linux-gnu.so Modules/_hashlib.cpython-313-x86_64-linux-gnu.so Modules/_tkinter.cpython-313-x86_64-linux-gnu.so Modules/xxsubtype.cpython-313-x86_64-linux-gnu.so Modules/_xxtestfuzz.cpython-313-x86_64-linux-gnu.so Modules/_testbuffer.cpython-313-x86_64-linux-gnu.so Modules/_testinternalcapi.cpython-313-x86_64-linux-gnu.so Modules/_testcapi.cpython-313-x86_64-linux-gnu.so Modules/_testlimitedcapi.cpython-313-x86_64-linux-gnu.so Modules/_testclinic.cpython-313-x86_64-linux-gnu.so Modules/_testclinic_limited.cpython-313-x86_64-linux-gnu.so Modules/_testimportmultiple.cpython-313-x86_64-linux-gnu.so Modules/_testmultiphase.cpython-313-x86_64-linux-gnu.so Modules/_testsinglephase.cpython-313-x86_64-linux-gnu.so Modules/_testexternalinspection.cpython-313-x86_64-linux-gnu.so Modules/_ctypes_test.cpython-313-x86_64-linux-gnu.so Modules/xxlimited.cpython-313-x86_64-linux-gnu.so Modules/xxlimited_35.cpython-313-x86_64-linux-gnu.so',
    'SHELL': '/bin/sh -e',
    'SHLIBS': '-ldl',
    'SHLIB_SUFFIX': '.so',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': 'LD_LIBRARY_PATH=/home/build ./python -E',
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': 'LD_LIBRARY_PATH=/home/build ./python -E -m test',
    ...
    'abs_builddir': '/home/build',
    'abs_srcdir': '/home/build',
